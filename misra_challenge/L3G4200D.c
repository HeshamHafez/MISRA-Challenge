...
static u16 u16ReadAxisData(u8 AxisMask)
{
    ...
    case u8NEW_DATA_AVAILABEL_Y_MASK:
    {
        ...
        u16AxisData = u8RegData1 | ((u16)(u8RegData2<<8u));
    }
    break;
...
static void vidInitSelectiveAxisMovement(void)
{
    ...
    u8RegData_2 = (u8)((L3G4200D_ConfigParam.strIntCfg.u8XAxisInterrupt) | (L3G4200D_ConfigParam.strIntCfg.u16ThresholdY) | (L3G4200D_ConfigParam.strIntCfg.u16ThresholdZ));
